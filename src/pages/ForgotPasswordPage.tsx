...
const ForgotPasswordPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_API}/api/admin/forgot-password`, {
    ...
    <div style={pageStyle} className="forgot-password-container">
      <div style={formContainerStyle}>
        ...
        <p style={{ textAlign: "center", marginTop: "20px" }}>
          Remembered your password? <a href="/" style={linkStyle} className="forgot-password-link">Sign in</a>
        </p>
